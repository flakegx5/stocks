...
本项目位于 `/Users/flakeliu/projects/stocks/`（本地），或其他设备 clone 后的根目录。
...
```bash
cd /Users/flakeliu/projects/stocks
...
```
0 17 * * 1-5  cd /Users/flakeliu/projects/stocks && python3 scrape_iwencai_xhr.py --build --push >> /tmp/hk_stocks_daily.log 2>&1
```
